        ...
        return CompletableFuture.supplyAsync(()->{
            try {
                ...
                Employee newEmployee = Employee.builder()
                        ...
                        .phoneNumber(createAccountRequest.getPhone_number())
                        .aboutMe(createAccountRequest.getAbout_me())
                        .createdAt(ZonedDateTime.now())
                        .updatedAt(ZonedDateTime.now())
                        .isDeleted(false)
                        .role(role.getRoleName())
                        .status(AccountStatus.NOT_ACTIVE.getStatusName())
                        .firstName(createAccountRequest.getFirst_name())
                        .username(createAccountRequest.getFirst_name().toLowerCase())
                        .lastName(createAccountRequest.getLast_name())
                        .staffId(EmployeeIdUtil.generateSupervisorId().toLowerCase())
                        .address(createAccountRequest.getAddress())
                        .dateOfBirth(createAccountRequest.getDate_of_birth())
                        .profilePicture(profile_picture_url)
                        .identificationNumber(createAccountRequest.getIdentification_number())
                        .identificationCardFront(id_card_front_url)
                        .identificationCardBack(id_card_back_url)
                ...
                return CreateAccountResponse.builder()
                        ...
                        .staff_id(newEmployee.getStaffId())
